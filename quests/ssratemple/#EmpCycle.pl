...
my $BloodCoolDownTime = 15; #Waiting time to reattempt Emp after failure (Current setting: 3-4 hours)
my $EmpRepopTime = 120; #Respawn time for Emp after success (Current setting: 3-5 days)
